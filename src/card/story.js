...
storiesOf('Card', module)
  ...
  .add('Card Modal with long header', () => (
    <Card type="modal">
  ...
  .add('Indeterminate Loading Card', () => (
    <Card>
  ...
  .add('Indeterminate Loading Card w/ Dark Card Well', () => (
    <Card>
      <CardLoading indeterminate />
      <CardWell type="dark">
        On average, peak utilization of <CardWellHighlight>18%</CardWellHighlight> happens
