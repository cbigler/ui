...
const ICONS = {
  IconImageUpload: <svg width='18' height='18' viewBox='0 0 18 18' xmlns='http://www.w3.org/2000/svg'>
    <g id='Page-1' fill='none' fillRule='evenodd'>
        <g id='IconImageUpload' transform='translate(-1 -1)'>
            <rect id='bounds' fillOpacity='0' fill='#E3E3E6' width='20' height='20'
            />
            <polyline id='icon-square-copy' stroke='#222A2E' strokeWidth='1.5' strokeLinecap='square'
            strokeLinejoin='round' points='5 8 2 8 2 18 18 18 18 8 15 8' />
            <polyline id='Stroke-3' stroke='#222A2E' strokeWidth='1.5' strokeLinecap='square'
            strokeLinejoin='round' points='13 5 10 2 7 5' />
            <path d='M10,8 L10,3' id='Stroke-4' stroke='#222A2E' strokeWidth='1.5'
            strokeLinecap='square' strokeLinejoin='round' />
            <polyline id='Path-2' stroke='#222A2E' strokeWidth='1.5' points='1.99926758 18.0160522 6.0098877 13.0065918 9 15.0160522 13.0057373 10.972168 18 18.0160522'
            />
        </g>
    </g>
  </svg>,
  IconImage: <svg width='18' height='18' viewBox='0 0 18 18' xmlns='http://www.w3.org/2000/svg'>
      <g id='Page-1' fill='none' fillRule='evenodd'>
          <g id='IconImage' transform='translate(-1 -1)'>
              <rect id='bounds' fillOpacity='0' fill='#E3E3E6' width='20' height='20'
              />
              <polygon id='icon-square-copy' stroke='#222A2E' strokeWidth='1.5' strokeLinecap='round'
              strokeLinejoin='round' points='2 18 18 18 18 2 2 2' />
              <polyline id='Path-2' stroke='#222A2E' strokeWidth='1.5' points='1.99926758 18.0160522 6.0098877 11.0065918 9 14.0160522 13.0057373 6.97216797 18 18.0160522'
              />
              <circle id='Oval' stroke='#222A2E' strokeWidth='1.5' cx='6' cy='6' r='2'
              />
          </g>
      </g>
  </svg>,
  IconInfo: <svg width='18' height='18' viewBox='0 0 18 18' xmlns='http://www.w3.org/2000/svg'>
      <g id='Page-1' fill='none' fillRule='evenodd'>
          <g id='IconInfo' transform='translate(-1 -1)'>
              ...
              id='Stroke-1' stroke='#000' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round'
              />
              <path d='M10,14 L10,9' id='Stroke-3' stroke='#000' strokeWidth='1.5' strokeLinecap='square'
              strokeLinejoin='round' />
              <path d='M10,6 L10,5.9219' id='Stroke-5' stroke='#000' strokeWidth='1.5'
              strokeLinecap='square' strokeLinejoin='round' />
          </g>
      </g>
  </svg>,
  IconStopWatch: <svg width='16' height='18' viewBox='0 0 16 18' xmlns='http://www.w3.org/2000/svg'>
      <g id='Page-1' fill='none' fillRule='evenodd'>
          <g id='IconStopWatch' transform='translate(-2 -1)' fill='#000' fillRule='nonzero'>
  ...
  IconGym: <svg width="18" height="12" viewBox="0 0 18 12" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconGym" transform="translate(-1 -4)" fill="#000" fillRule="nonzero">
  ...
  IconPerson: <svg width="14" height="18" viewBox="0 0 14 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconPerson" transform="translate(-3 -1)" fill="#000" fillRule="nonzero">
  ...
  IconLightning: <svg width="16" height="18" viewBox="0 0 16 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconLightning" transform="translate(-2 -1)" fill="#000" fillRule="nonzero">
  ...
  IconBucket: <svg width="16" height="14" viewBox="0 0 16 14" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconBucket" transform="translate(-2 -3)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <g id="Group-7" transform="translate(2 4)" stroke="#000" strokeLinejoin="round"
              strokeWidth="1.5">
  ...
  IconPlane: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconPlane" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconMoney: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconMoney" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconSoup: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconSoup" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconDragDrop: <svg width="18" height="17" viewBox="0 0 18 17" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconDragDrop" transform="translate(-1 -2)" fill="#222A2E" fillRule="nonzero">
  ...
  IconZoom: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconZoom" transform="translate(-1 -1)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <g id="Group" transform="translate(2 2)" stroke="#000" strokeLinejoin="round"
              strokeWidth="1.5">
  ...
  IconSearch: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconSearch" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconShare: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconShare" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconDownload: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconDownload" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconExport: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconExport" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconCircle: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconCircle" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconProgress: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconProgress" transform="translate(-1 -1)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <g id="Page-1" transform="translate(2 2)" stroke="#B5B8BE" strokeLinejoin="round"
              strokeWidth="1.5">
  ...
  IconClock: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconClock" transform="translate(-1 -1)">
              ...
              id="Stroke-1" stroke="#B5B8BE" strokeWidth="1.5" strokeLinejoin="round"
              />
              <polyline id="Stroke-3" stroke="#B5B8BE" strokeWidth="1.5" strokeLinejoin="round"
              points="10 6 10 10 14 10" />
          </g>
      </g>
  </svg>,
  IconGlobe: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconGlobe" transform="translate(-1 -1)">
              ...
              id="Stroke-3" stroke="#B5B8BE" strokeWidth="1.5" strokeLinejoin="round"
              />
              ...
              id="Stroke-5" stroke="#B5B8BE" strokeWidth="1.5" strokeLinejoin="round"
              />
          </g>
      </g>
  </svg>,
  IconShow: <svg width="18" height="14" viewBox="0 0 18 14" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconShow" transform="translate(-1 -3)">
              ...
              id="icon_circle" stroke="#000" strokeWidth="1.5" strokeLinecap="round"
              strokeLinejoin="round" />
              <circle id="Oval-2" stroke="#000" strokeWidth="1.5" cx="10" cy="10" r="2"
              />
          </g>
      </g>
  </svg>,
  IconHide: <svg width="18" height="14" viewBox="0 0 18 14" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconHide" transform="translate(-1 -3)">
              ...
              id="icon_circle" stroke="#000" strokeWidth="1.5" strokeLinecap="round"
              strokeLinejoin="round" />
              <path d="M2,10 L18,10" id="Path-9" stroke="#000" strokeWidth="1.5" />
          </g>
      </g>
  </svg>,
  IconLocate: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconLocate" transform="translate(-1 -1)">
              ...
              id="icon_circle" stroke="#000" strokeWidth="1.5" strokeLinecap="round"
              strokeLinejoin="round" />
              <path d="M1,10 L4,10" id="Path-8" stroke="#000" strokeWidth="1.5" />
              <path d="M16,10 L19,10" id="Path-8-Copy-3" stroke="#000" strokeWidth="1.5"
              />
              <path d="M10,19 L10,16" id="Path-8-Copy" stroke="#000" strokeWidth="1.5"
              />
              <path d="M10,4 L10,1" id="Path-8-Copy-2" stroke="#000" strokeWidth="1.5"
              />
          </g>
      </g>
  </svg>,
  IconCards: <svg width="18" height="17" viewBox="0 0 18 17" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconCards" transform="translate(-1 -2)" fill="#000" fillRule="nonzero">
  ...
  IconSquare: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconSquare" transform="translate(-1 -1)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <polygon id="icon-square" stroke="#000" strokeWidth="1.5" strokeLinecap="round"
              strokeLinejoin="round" points="2 18 18 18 18 2 2 2" />
          </g>
      </g>
  </svg>,
  IconMenu: <svg width="18" height="12" viewBox="0 0 18 12" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconMenu" transform="translate(-1 -4)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <path d="M18,10 L2,10" id="Stroke-3" stroke="#000" strokeWidth="1.5" strokeLinecap="square"
              strokeLinejoin="round" />
              <path d="M18,5 L2,5" id="Stroke-3-Copy" stroke="#000" strokeWidth="1.5"
              strokeLinecap="square" strokeLinejoin="round" />
              <path d="M18,15 L2,15" id="Stroke-3-Copy-2" stroke="#000" strokeWidth="1.5"
              strokeLinecap="square" strokeLinejoin="round" />
          </g>
      </g>
  </svg>,
  IconRefresh: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconRefresh" transform="translate(-1 -1)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <polyline id="Stroke-1" stroke="#000" strokeWidth="1.5" strokeLinecap="square"
              strokeLinejoin="round" points="2 2 2 7 7 7" />
              <polyline id="Stroke-3" stroke="#000" strokeWidth="1.5" strokeLinecap="square"
              ...
              id="Stroke-5" stroke="#000" strokeWidth="1.5" strokeLinejoin="round" />
              ...
              id="Stroke-7" stroke="#000" strokeWidth="1.5" strokeLinejoin="round" />
          </g>
      </g>
  </svg>,
  IconTag: <svg width="19" height="19" viewBox="0 0 19 19" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconTag">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              ...
              id="Combined-Shape" fill="#000" fillRule="nonzero" />
          </g>
      </g>
  </svg>,
  IconCalendar: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
  ...
  IconList: <svg width="16" height="12" viewBox="0 0 16 12" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconList" transform="translate(-2 -4)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <path d="M2,5 L6,5" id="Stroke-1" stroke="#000" strokeWidth="1.5" strokeLinejoin="round"
              />
              <path d="M8,5 L18,5" id="Stroke-3" stroke="#000" strokeWidth="1.5" strokeLinejoin="round"
              />
              <path d="M2,10 L6,10" id="Stroke-5" stroke="#000" strokeWidth="1.5" strokeLinejoin="round"
              />
              <path d="M8,10 L18,10" id="Stroke-7" stroke="#000" strokeWidth="1.5" strokeLinejoin="round"
              />
              <path d="M2,15 L6,15" id="Stroke-9" stroke="#000" strokeWidth="1.5" strokeLinejoin="round"
              />
              <path d="M8,15 L18,15" id="Stroke-11" stroke="#000" strokeWidth="1.5"
              strokeLinejoin="round" />
          </g>
      </g>
  </svg>,
  IconCheveronDownCircle: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
  ...
  IconCheveronDown: <svg width="18" height="10" viewBox="0 0 18 10" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconChevronDown" transform="translate(-1 -5)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <polyline id="icon-down" stroke="#000" strokeWidth="1.5" strokeLinecap="square"
              strokeLinejoin="round" transform="rotate(-180 10 10)" points="2 14 10 6 18 14"
              />
          </g>
      </g>
  </svg>,
  IconCheveronUpCircle: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
  ...
  IconCheveronUp: <svg width="18" height="10" viewBox="0 0 18 10" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconChevronUp" transform="translate(-1 -5)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <polyline id="icon-up" stroke="#000" strokeWidth="1.5" strokeLinecap="square"
              strokeLinejoin="round" points="2 14 10 6 18 14" />
          </g>
      </g>
  </svg>,
  IconCheveronLeftCircle: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
  ...
  IconCheveronLeft: <svg width="10" height="18" viewBox="0 0 10 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconChevronLeft" transform="translate(-5 -1)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <polyline id="icon-next-left-copy" stroke="#000" strokeWidth="1.5" strokeLinecap="square"
              strokeLinejoin="round" transform="rotate(-90 10 10)" points="2 14 10 6 18 14"
              />
          </g>
      </g>
  </svg>,
  IconCheveronRightCircle: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
  ...
  IconCheveronRight: <svg width="10" height="18" viewBox="0 0 10 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconChevronRight" transform="translate(-5 -1)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <polyline id="icon-next-right" stroke="#000" strokeWidth="1.5" strokeLinecap="square"
              strokeLinejoin="round" transform="rotate(90 10 10)" points="2 14 10 6 18 14"
              />
          </g>
      </g>
  </svg>,
  IconNo: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconNo" transform="translate(-1 -1)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <path d="M5,15 L15,5" id="Stroke-1" stroke="#000" strokeWidth="1.5" strokeLinecap="square"
              strokeLinejoin="round" />
              <path d="M18,10 C18,14.4182222 14.4183333,18 10,18 C5.58177778,18 2,14.4182222 2,10 C2,5.58166667 5.58177778,2 10,2 C14.4183333,2 18,5.58166667 18,10 L18,10 Z"
              id="Stroke-2" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"
              />
          </g>
      </g>
  </svg>,
  IconArrowRight: <svg width="17" height="12" viewBox="0 0 17 12" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconArrowRight" transform="rotate(90 11 7)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <path d="M10,18 L10,2" id="Stroke-1" stroke="#000" strokeWidth="1.5" strokeLinejoin="round"
              />
              <polyline id="Stroke-3" stroke="#000" strokeWidth="1.5" strokeLinecap="square"
  ...
  IconArrowLeft: <svg width="17" height="12" viewBox="0 0 17 12" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
  ...
  IconLogout: <svg width="18" height="17" viewBox="0 0 18 17" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconLogout" transform="translate(-1 -2)">
              <rect id="bounds" fillOpacity="0" fill="#E3E3E6" width="20" height="20"
              />
              <g id="Group-6" transform="translate(2 2)" stroke="#000" strokeLinejoin="round"
              strokeWidth="1.5">
  ...
  IconError: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconError" transform="translate(-1 -1)">
              ...
              strokeLinejoin="round" points="2 18 18 18 18 2 2 2" />
              <path d="M8.5,10.9219 L8.5,5.9219" id="Stroke-3" stroke="#000" strokeWidth="1.5"
              strokeLinecap="square" strokeLinejoin="round" transform="rotate(-180 9.25 8.422)"
              />
              <path d="M10,14 L10,13.9219" id="Stroke-5" stroke="#000" strokeWidth="1.5"
              strokeLinecap="square" strokeLinejoin="round" transform="rotate(-180 10 13.96)"
              />
          </g>
      </g>
  </svg>,
  IconCalendar: <svg width="19" height="16" viewBox="0 0 19 16" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconCalendar" transform="translate(0 -3)" fill="#353E42" fillRule="nonzero">
  ...
  IconDoorway: <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
    <g id="Page-1" fill="none" fillRule="evenodd">
        <g id="IconDoorway" transform="translate(-2 -2)" fill="#222A2E">
  ...
  IconCopy: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconCopy" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconLink: <svg width="18" height="8" viewBox="0 0 18 8" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconLink" transform="translate(-1 -6)" fill="#000" fillRule="nonzero">
  ...
  IconLinkBroken: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconLinkBroken" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconTrash: <svg width="16" height="18" viewBox="0 0 16 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconTrash" transform="translate(-2 -1)" fill="#000" fillRule="nonzero">
  ...
  IconDownload: <svg width="14" height="17" viewBox="0 0 14 17" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconDownload" transform="rotate(-180 8.5 9)" fill="#000" fillRule="nonzero">
  ...
  IconArrowDown: <svg width="12" height="17" viewBox="0 0 12 17" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconArrowDown" transform="rotate(-180 8 9)" fill="#000" fillRule="nonzero">
  ...
  IconArrowUp: <svg width="12" height="17" viewBox="0 0 12 17" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconArrowUp" transform="translate(-4 -1)" fill="#000" fillRule="nonzero">
              <polygon id="Stroke-1" points="10.75 18 10.75 2 9.25 2 9.25 18" />
              <path d="M10,3.06066017 L15,8.06066017 L16.0606602,7 L10.5303301,1.46966991 C10.2374369,1.1767767 9.76256313,1.1767767 9.46966991,1.46966991 L3.93933983,7 L5,8.06066017 L10,3.06066017 Z"
              id="Stroke-3" />
          </g>
  ...
  IconMinus: <svg width="18" height="2" viewBox="0 0 18 2" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconMinus" transform="translate(-1 -9)" fill="#000" fillRule="nonzero">
              <polygon id="Stroke-3" points="18.75 9.25 1.25 9.25 1.25 10.75 18.75 10.75"
              />
          </g>
      </g>
  </svg>,
  IconSwitch: <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconSwitch" transform="translate(-2 -2)" fill="#222A2E">
  ...
  IconPlus: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconPlus" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
              <polygon id="Stroke-3" points="18.75 9.25 1.25 9.25 1.25 10.75 18.75 10.75"
              />
  ...
  IconMinusCircle: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconMinusCircle" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconPlusCircle: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconPlusCircle" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconClose: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconClose" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconCloseCircle: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconCloseCircle" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconCloseSquare: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconCloseSquare" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconCheck: <svg width="18" height="15" viewBox="0 0 18 15" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconCheck" transform="translate(-1 -3)" fill="#000" fillRule="nonzero">
  ...
  IconCheckCircle: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconCheckCircle" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
  ...
  IconCheckSquare: <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" fill="none" fillRule="evenodd">
          <g id="IconCheckSquare" transform="translate(-1 -1)" fill="#000" fillRule="nonzero">
...
for (let iconName in ICONS) {
  ICON_COMPONENTS[iconName] = function IconComponent() {
