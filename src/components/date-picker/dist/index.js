...
exports.ANCHOR_LEFT = exports.ANCHOR_RIGHT = undefined;
...
function DatePicker(props) {
  ...
  return React.createElement(
    'div',
    { className: (0, _classnames2.default)('date-picker', {
    ...
    React.createElement(_reactDates.SingleDatePicker, _extends({
      numberOfMonths: 1,
